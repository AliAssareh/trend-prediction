...
class KAMAIndicator(IndicatorMixin):
    ...
    def kama(self) -> pd.Series:
        ...
        kama_series = self._check_fillna(kama_series, value=self._close.mean())
        scaled = (kama_series - self._open) / self._open
        return pd.Series(scaled, name="kama")
...
class AwesomeOscillatorIndicator(IndicatorMixin):
    ...
    def awesome_oscillator(self) -> pd.Series:
        ...
        scaled = ao_series / self._open
        return pd.Series(scaled, name="ao")
